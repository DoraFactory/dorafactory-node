...
echo "build dorafactory chainspec"

./dorafactory-node build-spec --disable-default-bootnode --chain dev >  ./config/dorafactory-dev.json
./dorafactory-node export-genesis-state --chain ./config/dorafactory-dev.json > ./config/dorafactory-dev.genesis
./dorafactory-node export-genesis-wasm --chain ./config/dorafactory-dev.json > ./config/dorafactory-dev.wasm
