...
./target/release/dorafactory-node build-spec --disable-default-bootnode > rococo-local-parachain-2052-plain.json
echo "正在生成chain spec2..."
./target/release/dorafactory-node build-spec --chain rococo-local-parachain-2052-plain.json --raw --disable-default-bootnode > rococo-local-parachain-2052-raw.json
echo "正在生成genesis..."
